...
export default function DefaultInputs() {
  ...
  return (
    <ComponentCard title="Entrée vos informations personnelles">
      <div className="space-y-6">
        <div>
          <Label htmlFor="input" className="flex">
            Nom
            <div className="text-red-600">&nbsp; *</div></Label>
          <Input type="text" placeholder="Votre nom de famille" id="input" />
        </div>
        <div>
          <Label htmlFor="input" className="flex">
            Prénom
            <div className="text-red-600">&nbsp; *</div></Label>
          <Input type="text" placeholder="Votre prénom" id="input" />
        </div>
        <div>
